...
func runLoop(r io.Reader, w io.Writer, errW io.Writer, exit chan struct{}) {
	var (
		input    string
		err      error
	...
	for {
		select {
		case <-exit: // defined on line 16
			fmt.Fprintln(w, "exiting gracefully...")
			return
		default:
